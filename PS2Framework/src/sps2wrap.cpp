...
//	int x1 = (2048 + (sps2UScreenGetWidth() >> 1)) << 4; // x1 is not used
	...
	VIFStaticDMA.Add128(GS_GIFTAG_BATCH(5 + (20 * 2), 1, 0, 0, 
	...
	VIFStaticDMA.Add64(ALPHA_SET(0, 1, 0, 1, 128));
	VIFStaticDMA.Add64(ALPHA_1);
